...
import pytest
from threshold_mpc_wallet.models import FrontierPayload, ExecutionStatus
from threshold_mpc_wallet.engine import FrontierDomainEngine
from threshold_mpc_wallet.agents import FROSTShareSignerAgent, NonceCommitmentAuditorAgent, ThresholdAggregatorAgent, ThresholdWalletCoordinator
from threshold_mpc_wallet.cli import main


def test_sub_agents():
    a1 = FROSTShareSignerAgent()
    ...
    a2 = NonceCommitmentAuditorAgent()
...
def test_coordinator():
    coord = ThresholdWalletCoordinator()
    ...
    assert "IETF FROST & GG20 Multi-Party Computation" in ans or "specifications" in ans
