"""
Autonomous Bayesian Calibration & Active Learning Feedback Engine for threshold-ecdsa-ed25519-agent.
"""
...
class ActiveLearningEngine:
    ...
    def __init__(self, system_name: str = "Threshold Ecdsa Ed25519 Agent"):
