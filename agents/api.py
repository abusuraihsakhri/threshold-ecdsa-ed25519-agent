...
app = FastAPI(
    title="Threshold Ecdsa Ed25519 Agent API",
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "threshold-ecdsa-ed25519-agent", "domain": "Clinical & Biomedical AI", "standard": "CAP / CLSI / ISO Standards", "version": "3.0.0-ENTERPRISE"}
