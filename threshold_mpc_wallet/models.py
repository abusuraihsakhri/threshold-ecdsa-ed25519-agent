"""
Data Models & Telemetry Definitions for Threshold ECDSA / Ed25519 Distributed MPC Wallet Custody Supervisor.
...
class AgentTelemetryAlert:
    ...
    standard_reference: str = "IETF FROST & GG20 Multi-Party Computation"
    timestamp: str = field(default_factory=lambda: datetime.datetime.now(datetime.timezone.utc).isoformat())
